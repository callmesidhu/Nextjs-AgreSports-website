  ...
  const players: Player[] = [
    {
      ...
      age: 22,
      country: 'USA',
      bio: 'A fearless entry fragger known for high-impact plays.',
    },
    {
      name: 'Player Two',
      role: 'Initiator',
      age: 24,
      country: 'Canada',
      bio: 'Expert at creating space for the team with utility usage.',
    },
    {
      name: 'Player Three',
      role: 'Controller',
      age: 21,
      country: 'Germany',
      bio: 'Master of map control and zoning out opponents.',
    },
    {
      name: 'Player Four',
      role: 'Sentinel',
      age: 23,
      country: 'South Korea',
      bio: 'Defensive anchor who holds angles and watches flanks.',
    },
  ];
      ...
      <AnimatePresence>
        {selectedPlayer && (
          ...
          >
            ...
            <motion.div
              className="relative bg-neutral-900 text-white rounded-lg p-6 flex max-w-3xl w-full z-30 "
...
function FlipCard({ player, onClick }: { player: Player; onClick: () => void }) {
  return (
    <div
      className="w-60 h-80 group cursor-pointer"
      onClick={onClick}
    >
